...
const { listarAtividadesUsuario, createAtividadeUsuario, atualizarAtividadeUsuario, removerAtividadeUsuario, atualizarStatus } = require('../controller/atividade_usuario_controller');
...
router.put("/atividade-usuario/status/:id", atualizarStatus);
